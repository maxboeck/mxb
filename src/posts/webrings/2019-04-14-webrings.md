...
<p class="lead">After Tatiana Mac proposed to [bring webrings back](https://twitter.com/TatianaTMac/status/1114388079630929926), I hacked something new together over the weekend: A starter kit for hosting your own webring!</p>

## What's that?

A [webring](https://en.wikipedia.org/wiki/Webring) is a blast from the past: In the 90s, sites about a common topic could join together in a central index. To be a member, you had to embed a little widget on your page that contained a "forward", a "backward", and a "random" button. These buttons would then link to the next or previous site in the ring.
